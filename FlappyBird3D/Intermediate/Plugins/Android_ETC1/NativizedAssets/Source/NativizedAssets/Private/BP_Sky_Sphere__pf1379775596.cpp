		...
		case 7:
			{
				...
				bpfv__CallFunc_Conv_ColorToLinearColor_ReturnValue__pf = UKismetMathLibrary::Conv_ColorToLinearColor(((IsValid(bpv__Directionalxlightxactor__pfTT) && IsValid((*(AccessPrivateProperty<ULightComponent* >((bpv__Directionalxlightxactor__pfTT), ALight::__PPO__LightComponent() ))))) ? ((*(AccessPrivateProperty<ULightComponent* >((bpv__Directionalxlightxactor__pfTT), ALight::__PPO__LightComponent() )))->LightColor) : (__Local__4)));
				if(IsValid(bpv__Skyxmaterial__pfT))
				{
...
void ABP_Sky_Sphere_C__pf1379775596::bpf__UpdateSunDirection__pf()
{
	...
	bpfv__CallFunc_Conv_ColorToLinearColor_ReturnValue__pf = UKismetMathLibrary::Conv_ColorToLinearColor(((IsValid(bpv__Directionalxlightxactor__pfTT) && IsValid((*(AccessPrivateProperty<ULightComponent* >((bpv__Directionalxlightxactor__pfTT), ALight::__PPO__LightComponent() ))))) ? ((*(AccessPrivateProperty<ULightComponent* >((bpv__Directionalxlightxactor__pfTT), ALight::__PPO__LightComponent() )))->LightColor) : (__Local__5)));
	if(IsValid(bpv__Skyxmaterial__pfT))
	{
		bpv__Skyxmaterial__pfT->UMaterialInstanceDynamic::SetVectorParameterValue(FName(TEXT("Sun color")), bpfv__CallFunc_Conv_ColorToLinearColor_ReturnValue__pf);
	}
...
void ABP_Sky_Sphere_C__pf1379775596::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
	...
	const FCompactBlueprintDependencyData LocCompactBlueprintDependencyData[] =
	{
		...
		{8, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  Class /Script/Engine.CurveLinearColor 
		...
		{10, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  Class /Script/Engine.MaterialInstanceDynamic 
		...
		{13, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  Class /Script/Engine.Light 
		{14, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  Class /Script/Engine.LightComponentBase 
	};
	for(const FCompactBlueprintDependencyData CompactData : LocCompactBlueprintDependencyData)
	{
		AssetsToLoad.Add(FBlueprintDependencyData(
